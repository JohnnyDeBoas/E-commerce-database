...
class CostumersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create costumer" do
    assert_difference('Costumer.count') do
      post costumers_url, params: { costumer: { adress: @costumer.adress, name: @costumer.name, payment_prefer: @costumer.payment_prefer, state: @costumer.state, total_spent: @costumer.total_spent } }
    end
  ...
  test "should update costumer" do
    patch costumer_url(@costumer), params: { costumer: { adress: @costumer.adress, name: @costumer.name, payment_prefer: @costumer.payment_prefer, state: @costumer.state, total_spent: @costumer.total_spent } }
